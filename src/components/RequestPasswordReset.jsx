...
/**
 * @returns {JSX} The JSX representation of the Modalcomponent
...
function RequestPasswordReset(props) {
  ...
  // his is a function to update the email state
  ...
  const handleSubmit = async (event) => {
    ...
    props.requestPasswordReset(userEmail.email);
  };

  //  function that ensures that when modal is closed, content is lost
  ...
  return (
    <Modal clearMessage={clearModalState} title="Recover Password!">
      <p className="reset_password_paragraph">
        Enter the email address you used when you created your account.
        You will receive instructions to reset your password in your mail box.
      </p>
